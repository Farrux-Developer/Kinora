  ...
  return (
    <div className="mx-auto max-w-xl rounded-lg border border-line bg-paper p-8 text-center">
      ...
      <p className="mt-2 text-sm leading-relaxed text-mist">
        Добавьте ключ TMDB API в файл <code className="rounded bg-line px-1.5 py-0.5 text-fg">.env</code>{" "}
        (переменная <code className="rounded bg-line px-1.5 py-0.5 text-fg">TMDB_API_KEY</code>) и
