...
Каталог фильмов, сериалов : рейтинги, трейлеры, актёрские составы и персональные списки. Портфолио-проект уровня production: Server Components, кэширование внешнего API, авторизация, 3D-сцена в hero и аккуратная система дизайна.
